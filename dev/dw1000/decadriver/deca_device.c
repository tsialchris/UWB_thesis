...
//Added for random number generation
#include <stdio.h>
...
int dwt_writetxdata(uint16 txFrameLength, uint8 *txFrameBytes, uint16 txBufferOffset)
{
    ...
    //---------------ATTACK CODE-------------//
    //---------------------------------------//
    //uint8 random_txFrameBytes[txFrameLength];

    //int i;
    //for (i=0; i<txFrameLength; i++){
        //create a pseudo random number, smaller or equal to 255
        //store that number in the random_txFrameBytes array
    //    random_txFrameBytes[i] = rand() % 256;
    //}
    
    //uint8 *pointer_random_txFrameBytes;
    
    //pointer_random_txFrameBytes = random_txFrameBytes;
    
    //either do this, or replace txFrameBytes with pointer_random_txFrameBytes
    //txFrameBytes = pointer_random_txFrameBytes;
...
{
    //int nop_counter;
    //for(nop_counter = 0; nop_counter < 100000; nop_counter++){
    //    asm("nop");
    //}
    ...
    printf("End of dwt_setdelayedtrxtime, sending packet...\n");
